...
public final class StorageUtils {
	...
	private static final String INDIVIDUAL_DIR_NAME = "nightq_storage";
	...
	public static String getCacheDirectoryPath() {
		File file = getCacheDirectory(NightQAppLib.getAppContext());
		if (file == null){
			return null;
		}
	...
	/**
	 * 临时文件夹，用于存放各种乱七八糟的东西，不要随便清除
	 * 最好用户自己清除
	 * 比如存放临时头像，滤镜结果分享图片等
	 * @return
	 */
	public static String getAppTmpCacheDir() {
		return getCacheDirectoryPath() + "/nightqTmp";
	}
	...
	public static String getAppCacheDirCameraPath() {
		return getCacheDirectoryPath() + "/nightqCamera";
	}
	...
	public static String getAppCacheDirCachePath() {
		return getCacheDirectoryPath() + "/nightqPhoto";
	}

	/**
	 * 存放处理图片的文件夹
	 **/
	public static String getProcessTmpDirPath() {
		return getCacheDirectoryPath() + "/nightqProcessTmp";
	}
